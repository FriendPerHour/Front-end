...
const features = [
  {
    ...
    description:
      "مكالمات فيديو عالية الجودة مع واجهة محسنة لتواصل لغة الإشارة وقراءة الشفاه.",
    color: "text-primary",
  },
  {
    icon: MessageSquare,
    title: "دعم نصي فوري",
    description:
      "رسائل فورية مع إمكانيات تحويل النص إلى كلام والكلام إلى نص للتواصل السلس.",
  ...
  },
  {
    ...
    title: "دعم المجتمع",
    description:
      "تواصل مع الأقران ومجموعات الدعم والمتطوعين في منصة مجتمعنا الشاملة.",
    color: "text-primary",
  },
  {
    icon: Volume2,
    title: "تحسين الصوت",
    description:
      "معالجة صوتية متقدمة لمستخدمي السماعات وذوي فقدان السمع الجزئي.",
    color: "text-secondary",
  },
  {
    icon: Eye,
  ...
  },
  {
    ...
    description:
      "تصميم متوافق مع WCAG 2.1 AA مع التنقل بلوحة المفاتيح ودعم التقنيات المساعدة.",
    color: "text-secondary",
  },
  {
    icon: Heart,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            منصتنا الشاملة توفر الأدوات والدعم اللازم لكسر حواجز التواصل وتعزيز
            الروابط المعنوية.
          </p>
        </div>
                ...
                <div className="mb-4">
                  <div
                    className={`w-12 h-12 rounded-lg bg-gradient-to-br from-${
                      ...
                      feature.color.split("-")[1]
                    }/10 flex items-center justify-center mb-4 mr-auto`}
                  >
